...
export default function InvoicesPage() {
  ...
  return (
    <div>
      ...
      {!error && !invoices && <p className="text-sm text-gray-500">Cargando facturas...</p>}
            ...
            <tbody className="divide-y divide-gray-100">
              {invoices.map((invoice) => (
                <tr key={invoice.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-gray-700">{invoice.client.name}</td>
                  <td className="px-4 py-3 text-gray-700">{dateFormatter.format(new Date(invoice.dueDate))}</td>
                  <td className="px-4 py-3">
